...
ggplot(df,aes(x = 'a thing', y = tsnr)) +
  geom_boxplot()
...
ggplot(df,aes(x = 'a thing', y = tsnr)) +
  geom_boxplot() + 
  geom_dotplot(color = "black", binaxis='y', binwidth = 1, stackdir='center')
...
ggplot(df,aes(x = fd_mean, y = tsnr, color = task)) +
  geom_point()
